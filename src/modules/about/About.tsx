      ...
      <Container className={`container ${inView ? "about_visible" : null}`}>
        <div ref={ref} className="description">
          ...
          <Typography className="content" component="p">
            ...
            l&apos;integration de site web.<br></br> D&apos;abord autodidacte
            pendant quelques années, je me suis ensuite orienté vers une
            formation OpenClassrooms pour approfondir mes connaissances.{" "}
            <br></br>Je vous laisse découvrir mes compétences et differents
            projets personnels ainsi que quelques uns issus de ma formation.
          </Typography>
          <Typography component="p">Cédric.</Typography>
        </div>
